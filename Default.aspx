...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="divSport">
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:10%;height:370px;width:250px;">
        ...
        <!--    <h5 style="color:grey;margin-left:35%;">  <a href="News.aspx" onclick="sport1_Click"> Cititi Stirea </a> </h5>   -->     
             <asp:Button ID="btnSessionState" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click1" CssClass="col-md-offset-4" ForeColor="Red" />
        </div>
          
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:5%;height:370px;width:250px;position:absolute;">
            ...
            <asp:Button ID="Button1" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click2" CssClass="col-md-offset-4" ForeColor="Red" />       
        </div>

        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:26%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button2" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click3" CssClass="col-md-offset-4" ForeColor="Red" />    
        </div>

        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:47%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button3" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click4" CssClass="col-md-offset-4" ForeColor="Red" />            
        </div>
    ...
    <div id="divStiinta" runat="server" />
        <h2 style="padding-left:10%;color:deepskyblue;font-style:oblique;" > Stiinta </h2>
         ...
         <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:10%;height:370px;width:250px;">
            ...
            <asp:Button ID="Button4" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click5" CssClass="col-md-offset-4" ForeColor="Red" />             
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:5%;height:370px;width:250px;position:absolute;">
            ...
            <asp:Button ID="Button5" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click6" CssClass="col-md-offset-4" ForeColor="Red" />            
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:26%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button6" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click7" CssClass="col-md-offset-4" ForeColor="Red" />           
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:47%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button7" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click8" CssClass="col-md-offset-4" ForeColor="Red" />             
        </div>
    ...
    <div id="divTehnologie" runat="server" />
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:10%;height:370px;width:250px;">
            ...
            <asp:Button ID="Button8" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click9" CssClass="col-md-offset-4" ForeColor="Red" />            
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:5%;height:370px;width:250px;position:absolute;">
            ...
            <asp:Button ID="Button9" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click10" CssClass="col-md-offset-4" ForeColor="Red" />           
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:26%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button10" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click11" CssClass="col-md-offset-4" ForeColor="Red" />            
        </div>
        ...
        <div style="display:inline-block;border:solid 3px deepskyblue;margin-left:47%;height:370px;width:250px;position:absolute">
            ...
            <asp:Button ID="Button11" runat="server" Text="Cititi Stirea" OnClick="btnSessionState_Click12" CssClass="col-md-offset-4" ForeColor="Red" />            
        </div>
