...
public partial class Stiinta : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string query = "SELECT Id, Titlu, Poza, DataAdaugare FROM Stiri WHERE Categorie = 'Stiinta' ORDER BY DataAdaugare DESC";
    ...
    protected void schimb_sortare(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string query = "SELECT Id, Titlu, Poza, DataAdaugare FROM Stiri WHERE Categorie = 'Stiinta' ORDER BY Titlu ASC";
            SqlCommand cmd = new SqlCommand(query, con);
            SqlDataReader queryCommandReader = cmd.ExecuteReader();
            DataTable dataTable = new DataTable();
            dataTable.Load(queryCommandReader);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Stiinta.aspx");
    }
